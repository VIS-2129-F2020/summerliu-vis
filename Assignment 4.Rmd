...
CPL_parks <- st_read("https://data.townofcary.org/explore/dataset/parks-and-recreation-feature-map/download/?format=kml&timezone=America/New_York&lang=en")
```
...
```{r}
iso_5min_walk <- 
  otp_isochrone(otpcon = otpcon, fromPlace = CPL_parks, 
...
ggplot(iso_areas, 
  ...
  scale_y_continuous(name = 
            ...
            breaks = breaks <- seq(0, 2700000, by = 100000),
